          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <button
                ...
                className={`text-2xl font-bold ${isDarkMode ? 'text-blue-400' : 'text-blue-600'} ml-2 hover:text-blue-700 transition-colors`}
            ...
            <nav className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                <div className="relative">
                  <button
                    ...
                    className={`p-2 rounded-lg ${isDarkMode ? 'bg-gray-700 text-yellow-400' : 'bg-blue-50 text-gray-700'} 
                ...
                <div className="relative">
                  <button
                    ...
                    className={`p-2 rounded-lg ${highContrast ? 'bg-yellow-400 text-black' : 'bg-gray-200 text-gray-700'} 
                    hover:bg-opacity-80 transition-colors duration-200`}
              ...
              <div className="relative">
                ...
                >
                  <Bell className={`w-6 h-6 ${isDarkMode ? 'text-white' : ''}`} />
              ...
              <button className="p-2">
                <Settings className={`w-6 h-6 ${isDarkMode ? 'text-white' : ''}`} />
              </button>
            </nav>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex gap-6">
          ...
          <aside className="hidden md:block w-64">
            <Card className={`${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white'} shadow-sm`}>
